<template>
    <div class='blog-config'>
            ...
            <div class='content'>
                <el-form :inline="true" :model='formInline'>
                    <el-form-item label='配置项key'>
                        <el-input v-model='formInline.key' placeholder='配置项key' clearable></el-input>
                    </el-form-item>
                    <el-form-item label='配置项value'>
                        <el-input v-model='formInline.value' placeholder='配置项value' clearable></el-input>
                    </el-form-item>
                    <el-form-item>
        ...
        <el-dialog title='编辑系统配置' :visible.sync='dialogVisible' center width='30%'>
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                let scope = this;
                let form = {
                    configKey: scope.formInline.key,
                    configValue: scope.formInline.value
                };
                scope.page = {
                    recordStartNo: 0,
                    pageRecordNum: 20,

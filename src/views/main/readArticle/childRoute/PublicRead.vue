<template>
    <div class="public-read" ref='publicRead'>
        ...
        <div class="middle-frame">
            <kind-article :kinds="currentLabel" target='.public-read' @showHotArticle="showHotArticle = true"></kind-article>
        </div>
        <div class="right-frame">
            <hot-article :kinds="currentLabel" v-show='showHotArticle'></hot-article>
        </div>
    </div>
</template>
